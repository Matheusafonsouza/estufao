...
void wifi_start()
{
    ...
    ESP_LOGI(TAG, "WiFi init finalizado");
    ...
    {
        ESP_LOGI(TAG, "Conectado ao SSID %s, com a senha%s",
                 WIFI_SSID, WIFI_PASS);
    }
    else if (bits & WIFI_FAIL_BIT)
    {
        ESP_LOGI(TAG, "Falha ao conectar ao SSID %s, com a senha:%s",
                 WIFI_SSID, WIFI_PASS);
    }
    else
    {
        ESP_LOGE(TAG, "Falha inesperada na conexão");
    }
